...
# mean() function the average of the selected elements
...
# Calculate the average of the elements in sales lemonade from Tuesday to Thursday
avg_lemonade <- mean(tth_lemonade)

# Print out avg_lemonade (Tuesday to Thursday)
print(avg_lemonade)
