...
### Selection
In R, the square bracket [] operator is a versatile tool for selecting elements from various data structures, including vectors, matrices, data frames, and lists.
```{r}
# Create a vector of sales_burger
sales_burger <- c(100, 250, 75, 15, 20, 120, 150)
names(sales_burger) <- days_vector
