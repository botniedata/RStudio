...
## Selection of Entire column (using element number) ----

# Select the hashira variables from hashira_df
hashira_vector_1 <- hashira_df[ ,1]

# Print out hashira_vector (names)
hashira_vector_1

## Selection of Entire column (using column name) ----

# Select the hashira variables from hashira_df
hashira_vector_2 <- hashira_df[ ,"hashira"]

# Print out hashira_name_vector
hashira_vector_2

## Selection of Entire column (using '$' column name) ----

# Select the hashira variables from hashira_df
hashira_vector_3 <- hashira_df$hashira
